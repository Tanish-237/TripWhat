        ...
        {isAuthenticated ? (
          <>
            ...
            <div className="relative ml-2" ref={profileMenuRef}>
              ...
              >
                <div className="w-9 h-9 rounded-full overflow-hidden border-2 border-[var(--lavender)] group-hover:border-[var(--peach)] transition-colors duration-300">
                  <img
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-[var(--surface)] rounded-[1.25rem] py-2 z-50 border border-[var(--lavender)]">
                  <div className="px-4 py-3 border-b border-[var(--lavender)]">
                  ...
                  <div className="border-t border-[var(--lavender)] pt-1">
                    <button
                      onClick={() => { setShowProfileMenu(false); logout(); window.location.href = "/"; }}
